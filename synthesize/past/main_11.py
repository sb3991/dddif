...
from diffusers import StableDiffusionPipeline, EulerDiscreteScheduler, UNet2DConditionModel, StableDiffusionImg2ImgPipeline, DDIMScheduler, StableDiffusion3Pipeline, DPMSolverMultistepScheduler
import tqdm
import numpy as np
...
def main(args):
    ...
    scheduler = DDIMScheduler.from_pretrained(model_id, subfolder="scheduler") #DPMSolverMultistepScheduler
    pipe = StableDiffusionImg2ImgPipeline.from_pretrained(model_id,safety_checker=None,scheduler=scheduler,  torch_dtype=torch.float16).to("cuda") #DPMSolverMultistepScheduler,
