...
"""Synthesis"""
parser.add_argument("--early_stage", type=float, default=0.9, help="early denoising")
parser.add_argument("--late_stage", type=float, default=0.5, help="late denoising")
parser.add_argument("--prompt_strength", type=float, default=7.5, help="Text guidance scale")
parser.add_argument("--num_inference_steps", type=int, default=50, help="Number of denoising steps")
parser.add_argument("--classifier_scale", type=float, default=10.0, help="Classifier guidance scale")
parser.add_argument(
    "--arch-name",
    type=str,
    default="resnet18",
...
parser.add_argument("--re-epochs", default=500, type=int)
parser.add_argument(
    "--syn-data-path",
    type=str,
    default="syn_data",
